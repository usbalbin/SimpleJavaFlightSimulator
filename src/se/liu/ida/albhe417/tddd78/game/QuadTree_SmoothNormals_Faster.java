 ...
 */
public class QuadTree_SmoothNormals_Faster {
    //TODO implement me
    //Info: http://victorbush.com/2015/01/tessellated-terrain/

    private QuadTree_SmoothNormals_Faster leftFront;
    private QuadTree_SmoothNormals_Faster rightFront;
    private QuadTree_SmoothNormals_Faster leftBottom;
    private QuadTree_SmoothNormals_Faster rightBottom;
    private QuadTree_SmoothNormals_Faster parent;
    ...
    */
     ...
     */
    public QuadTree_SmoothNormals_Faster(float[] heightmap, final float heightFactor, float maxHeight){
     ...
     */
    private QuadTree_SmoothNormals_Faster(final Vector3 position, final int size, final short level, final Vector3 cameraPos, final float detailFactor, final short maxLevels, QuadTree_SmoothNormals_Faster parent) {
    ...
    private void generateTree(final Vector3 cameraPos, final float detailFactor, final short maxLevels){
        ...
        if(leftFront == null && rightFront == null && leftBottom == null && rightBottom == null) {
            leftFront = new QuadTree_SmoothNormals_Faster(position.add(new Vector3(-halfChildSize, 0, -halfChildSize)), childSize, childLevel, cameraPos, detailFactor, maxLevels, this);
            rightFront = new QuadTree_SmoothNormals_Faster(position.add(new Vector3(+halfChildSize, 0, -halfChildSize)), childSize, childLevel, cameraPos, detailFactor, maxLevels, this);
            leftBottom = new QuadTree_SmoothNormals_Faster(position.add(new Vector3(-halfChildSize, 0, +halfChildSize)), childSize, childLevel, cameraPos, detailFactor, maxLevels, this);
            rightBottom = new QuadTree_SmoothNormals_Faster(position.add(new Vector3(+halfChildSize, 0, +halfChildSize)), childSize, childLevel, cameraPos, detailFactor, maxLevels, this);
        }
        else {
     ...
     */
    //TODO fix me
    protected void stitch(QuadTree_SmoothNormals_Faster neighborLeft, QuadTree_SmoothNormals_Faster neighborFront, QuadTree_SmoothNormals_Faster neighborRight, QuadTree_SmoothNormals_Faster neighborBottom){
        //Stuff....
        //..
        //..
        if(hasChildren()){
    ...
    private void stitchLeft(final QuadTree_SmoothNormals_Faster leftNeighbor){
    ...
    private void stitchFront(final QuadTree_SmoothNormals_Faster frontNeighbor){
        //If our neighbor has children then either the matching quad has same(do nothing) or higher
        // LOD-level(neighbor will do the stitching)
    ...
    private void stitchRight(final QuadTree_SmoothNormals_Faster rightNeighbor){
        //If our neighbor has children then either the matching quad has same(do nothing) or higher
        // LOD-level(neighbor will do the stitching)
    ...
    private void stitchBottom(final QuadTree_SmoothNormals_Faster bottomNeighbor){
        //If our neighbor has children then either the matching quad has same(do nothing) or higher
        // LOD-level(neighbor will do the stitching)
...
/*private QuadTree getNortNeighbor(QuadType currentQuadType, QuadTree parent){
    ...
    protected QuadTree_SmoothNormals_Faster findNode(final Vector3 position){
