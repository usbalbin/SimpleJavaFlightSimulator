...
public class GameObjectPartPosColor extends AbstractGameObjectPart
{
    ...
    public GameObjectPartPosColor(final int shaderProgram, int bufferSize) {
        super(shaderProgram);
        setup(null, null);
        vertexBufferData = BufferUtils.createFloatBuffer(bufferSize * VertexPositionColor.FLOAT_COUNT);
    }

    public GameObjectPartPosColor(final VertexPositionColor[] vertices, int[] indices, final int shaderProgram, RigidBody physicsObject) {
        super(physicsObject, indices.length, shaderProgram);
